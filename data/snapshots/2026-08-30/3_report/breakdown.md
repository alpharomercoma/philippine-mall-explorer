# Mall directory scrape - breakdown (2026-08-30)

**304 properties · 41,789 listings · 10 chains**

Generated deterministically from the snapshot in `data/snapshots/2026-08-30/`. Regenerate with `mallscape report --date 2026-08-30`.

## Data quality

4,264 of 41,789 listings have no confidently mapped category.
505 normalized brand keys have multiple raw variants or require review.
...
| ayala      |         32 |      32 |      5,986 | 2026-08-30 | api.ayalamalls.com                          | explore-v2 JSON API                  |
| filinvest  |          5 |       5 |        953 | 2026-08-30 | filinvestlifemalls.com                      | server-rendered HTML table           |
| fishermall |          2 |       2 |        342 | 2026-08-30 | fishermall.com.ph                           | loadlevel.php HTML fragments         |
| megaworld  |         26 |      26 |      2,101 | 2026-08-30 | megaworld-lifestylemalls.com                | Contentstack headless CMS API        |
| ortigas    |          4 |       4 |      1,282 | 2026-08-30 | ortigasmalls.com                            | Laravel/Inertia data-page JSON       |
| robinsons  |         54 |      54 |      8,464 | 2026-08-30 | robinsonsmalls.com + vmd.robinsonsmalls.com | Drupal HTML + Google Sites fallback  |
| sm         |        126 |      95 |     19,843 | 2026-08-30 | smsupermalls.com                            | JSON API (list-of-malls + tenants)   |
| starmall   |          4 |       4 |        279 | 2026-08-30 | starmalls.com.ph                            | Elementor JSON-escaped blob          |
| waltermart |         47 |      47 |      2,220 | 2026-08-30 | malls.waltermart.com.ph                     | store index + per-store branches API |
| **total**  |    **304** | **273** | **41,789** |            |                                             |                                      |
...
### ayala (32 properties, 5,986 listings)

| property                    | region       | type | listings |
|-----------------------------|--------------|------|---------:|
| Market! Market!             | metro-manila | mall |      495 |
| Ayala Center Cebu           | visayas      | mall |      409 |
| Glorietta                   | metro-manila | mall |      396 |
| Trinoma                     | metro-manila | mall |      391 |
| Ayala Malls Manila Bay      | metro-manila | mall |      357 |
| Abreeza                     | mindanao     | mall |      307 |
| Ayala Malls Capitol Central | visayas      | mall |      275 |
| U. P. Town Center           | metro-manila | mall |      253 |
| MarQuee Mall                | north-luzon  | mall |      251 |
| Ayala Malls Feliz           | metro-manila | mall |      235 |
| Greenbelt                   | metro-manila | mall |      232 |
| Centrio Mall                | mindanao     | mall |      217 |
| Ayala Malls Nuvali          | south-luzon  | mall |      213 |
| Ayala Malls Circuit         | metro-manila | mall |      188 |
| Fairview Terraces           | metro-manila | mall |      184 |
| One Ayala                   | metro-manila | mall |      162 |
| Ayala Malls Central Bloc    | visayas      | mall |      157 |
| Ayala Malls Vertis North    | metro-manila | mall |      149 |
| Harbor Point                | north-luzon  | mall |      144 |
| Ayala Malls Cloverleaf      | metro-manila | mall |      126 |
| Ayala Malls Serin           | south-luzon  | mall |      105 |
...
| The District Imus           | south-luzon  | mall |       82 |
| Bonifacio High Street       | metro-manila | mall |       76 |
| Ayala Malls Legazpi         | south-luzon  | mall |       73 |
| Pavilion Mall               | south-luzon  | mall |       66 |
| Metro Point Mall            | metro-manila | mall |       52 |
...
### robinsons (54 properties, 8,464 listings)

| property                      | region       | type | listings |
|-------------------------------|--------------|------|---------:|
| Robinsons Place Manila        | metro-manila | mall |      659 |
| Robinsons Magnolia            | metro-manila | mall |      425 |
| Robinsons Galleria            | metro-manila | mall |      396 |
| Robinsons Place Antipolo      | metro-manila | mall |      311 |
...
| Robinsons Angeles             | north-luzon  | mall |       62 |
...
10,449 distinct brands after normalization.
...
| BANCO DE ORO           |   163 |      8 |
| PENSHOPPE              |   163 |     10 |
| EXECUTIVE OPTICAL      |   154 |     10 |
| KFC                    |   144 |      7 |
| VIVO                   |   144 |      9 |
| MANG INASAL            |   140 |      9 |
| FAMOUS BELGIAN WAFFLES |   139 |      5 |
| IAN DARCY              |   132 |      8 |
| KETTLE KORN            |   132 |      7 |
| NATIONAL BOOKSTORE     |   132 |      8 |
| AFICIONADO             |   126 |      8 |
| OPPO                   |   124 |      9 |
| GOLDILOCKS             |   123 |      9 |
| CHOWKING               |   121 |      8 |
