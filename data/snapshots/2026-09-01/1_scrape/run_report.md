# mallscape run report - 2026-09-01

- **araneta**: 4 malls, 319 store rows
- **ayala**: 32 malls, 5867 store rows
...
- **robinsons**: 54 malls, 8460 store rows
...
- ⚠ 15 malls hold under 25% of their chain's median tenant count:
  - ayala:ayala-serendra: 34 tenants against a chain median of 159
...
## Diff vs 2026-08-31
- ⚠ store-count drops >20% (possible redesign):
  - ('ayala', 'ayala-harbor-point'): 144 → 112 (-22%)
